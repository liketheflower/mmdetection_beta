...
resnet_img = np.load("resnetoutput_img_with_extreme_val_new.npy")
swin_img_no_extreme = np.load("swinoutput_img_without_extreme_val.npy")
resnet_img_no_extreme = np.load("resnetoutput_img_without_extreme_val_new.npy")
plt.subplot(2, 2, 1)
...
fig.tight_layout()
plt.tight_layout()
plt.savefig("feture_map_subplots_13inches_200dpi_v2.png", dpi=200)
